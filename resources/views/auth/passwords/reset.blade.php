...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                 <h4 style="font-weight: bold;margin-bottom: 10px;">Lấy lại mật khẩu</h4>
                    ...
                    <form method="POST" action="{{ route('password.request') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button style="background: #de4d4e;border: 0px;margin-left: 250px;" type="submit" class="btn btn-primary">
                                    {{ __('Lấy lại mật khẩu') }}
                                </button>
                            </div>
                        </div>
